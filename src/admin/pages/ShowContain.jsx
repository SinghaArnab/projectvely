...
const ShowContain = () => {
    ...
    const getData = () => {
        return getDocs(collection(fireStore, 'CourseContent'));
    }
...
const handelUpdate=(data,id)=>{
    ...
    return (
        <div className=" py-2 overflow-x-scroll lg:overflow-hidden sm:-mx-6 sm:px-2 lg:-mx-2 pr-10 lg:px-8 max-w-screen">
                ...
                <div className="flex justify-between">
                    <div className="inline-flex border rounded w-7/12 px-2 lg:px-6 h-12 bg-transparent">
                        <div className="flex flex-wrap items-stretch w-full h-full mb-6 relative">
                            ...
                            <input type="text" className="flex-shrink flex-grow flex-auto leading-normal tracking-wide w-px flex border border-none border-l-0 rounded rounded-l-none px-3 relative focus:outline-none text-xxs lg:text-xs text-gray-500 font-thin bg-transparent" placeholder="Search" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        {courseContain && courseContain.filter((x) => {
                            ...
                            return (
                                <tr key={index + 7656}>
                                    ...
                                    <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">{x && x.data().Date}</td>

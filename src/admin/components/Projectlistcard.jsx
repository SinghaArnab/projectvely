...
const Projectlistcard = ({ x, projectId }) => {
  ...
  const handelUpdate = (x, projectId) => {
    ...
    Navigate('/Dashboard/updateproject', { state: data });
  }
  ...
  return (
    <>
      <div className="max-w-sm lg:min-w-[45%] bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
        ...
        <h1 className="mt-4 text-gray-800  font-bold cursor-pointer"> {x.ProjectDes.slice(0, 50)}</h1>
        <div className="my-4">
          ...
          <div className="flex  w-full justify-evenly">
            ...
            <button onClick={() => handelUpdate(x, projectId)} className="mt-4 text-xl w-[40%] text-white bg-[crimson] py-2 rounded-xl shadow-lg">Edit</button>
